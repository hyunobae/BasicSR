...
def main(mode='folder'):
    ...
    if mode == 'folder':
        opt['dataroot_gt'] = '/home/knuvi/Desktop/hyunobae/BasicSR/datasets/train/gt'
        opt['dataroot_lq'] = '/home/knuvi/Desktop/hyunobae/BasicSR/datasets/train/lq'
        opt['dataroot_flow'] = None
        opt['meta_info_file'] = '/home/knuvi/Desktop/hyunobae/BasicSR/basicsr/data/meta_info/meta_info_Compressed_GT.txt'
        opt['io_backend'] = dict(type='disk')
    elif mode == 'lmdb':
        opt['dataroot_gt'] = '/home/knuvi/Desktop/hyunobae/BasicSR/datasets/REDS/train_sharp_with_val.lmdb'
        opt['dataroot_lq'] = '/home/knuvi/Desktop/hyunobae/BasicSR/datasets/REDS/train_sharp_bicubic_with_val.lmdb'
        opt['dataroot_flow'] = None
        opt['meta_info_file'] = '/home/knuvi/Desktop/hyunobae/BasicSR/basicsr/data/meta_info/meta_info_Compressed_GT.txt'
